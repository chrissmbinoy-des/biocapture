  ...
  ({ size = 24, className, ...props }, ref) => {
    return (
      <svg
        ...
        {...props}
      >
        {/* House gecko / wall lizard - top view, slanted, outline only */}
        <g transform="rotate(-20 12 12)">
          ...
          <path d="M12 16 Q8 18 6 20 Q4 22 3 21" strokeWidth="2" strokeLinecap="round" />
          ...
          <path d="M15 7 L19 4 M19 4 L20 3 M19 4 L19 2.5 M19 4 L18 2.5" strokeWidth="1.3" strokeLinecap="round" />
          {/* Back left leg with toes */}
          <path d="M9 14 L5 18 M5 18 L4 19.5 M5 18 L3.5 18 M5 18 L4 17" strokeWidth="1.3" strokeLinecap="round" />
          {/* Back right leg with toes */}
          <path d="M15 14 L19 18 M19 18 L20 19.5 M19 18 L20.5 18 M19 18 L20 17" strokeWidth="1.3" strokeLinecap="round" />
        </g>
      </svg>
    );
  }
